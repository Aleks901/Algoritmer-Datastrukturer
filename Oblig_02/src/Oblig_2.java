...
class Oblig_2
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.print("1:O(n) 2:O(n²) 3:O(log_n) 4:0(nlog2n) 5:0(n^3) 6:0(Eksponentiell) 7:0(Kombinatorisk)? ");
        valg = S.nextInt();
        System.out.print("n? ");
        n = S.nextLong();
        ...
        if (valg == 7 && n >= 30)
            System.out.println(", ...JVM mistet livs lysten");
        System.out.println();
    }
}